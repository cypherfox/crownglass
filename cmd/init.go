...
This file is part of crownglass
*/
package cmd
...
var initCmd = &cobra.Command{
	Use:   "init [path]",
	Short: "initialize a crownglass application",
	Long: `initialize a crownglass application.
	
	crownglass-cli init must be run inside of a go module (please run "go mod init <MODNAME>" first)
	`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Printf("Your crownglass application is ready at\n%s\n", projectPath)
	},
}
